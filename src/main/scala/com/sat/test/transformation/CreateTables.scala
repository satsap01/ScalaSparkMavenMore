...
object CreateTables {
  def main(args: Array[String]): Unit = {
    ...
    println("createTable_users_queryString : " + createTable_users_queryString)
    println("createTable_updatedUsers_queryString : " + createTable_updatedUsers_queryString)
    //################################################
...
//    val partitionPath = addPartition_tablePath
    val partitionPath = addPartition_tablePath.stripPrefix("file://")
    ...
    //################################################
    println("bbbbbb " + createDatabase_testdb_queryString)
